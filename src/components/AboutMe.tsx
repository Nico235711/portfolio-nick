...
export const AboutMe = () => {
  ...
  return (
    <div className="sm:w-1/2 w-full flex flex-col items-center justify-center  bg-transparent border-4 border-gray-100 backdrop-blur-sm p-5 shadow rounded text-white">
      <img
